...
const detalleCompraValidationRules = () => {
    return [
        body('compraId').notEmpty().withMessage("El campo es obligatorio").isInt().withMessage('Debe ser un número entero'),
...
module.exports = {
    detalleCompraValidationRules, validate,
}