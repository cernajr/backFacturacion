...
const compraValidationRules = () => {
    return [
        ...
        body('pagoId').notEmpty().withMessage("El campo es obligatorio").isInt().withMessage('Debe ser un número entero'),
        body('total')
...
module.exports = {
    compraValidationRules, validate,
}